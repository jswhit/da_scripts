...
recenter_ensmean_wgt=${recenter_ensmean_wgt:-"100"}
recenter_control_wgt=${recenter_control_wgt:-"0"}
pushd ${datapath2}
...
while [ $fh -le $FHMAX ]; do
   ...
   filename_meanout=${filename_meanout:-${fileprefix}_${analdate}_${charfhr}_${charnanal}}
