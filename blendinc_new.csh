...
set filename_anal2=sanl_${analdate}_${charfhr}_envar # EnVar analysis
...
setenv PGM "${execdir}/recentersigp_hybgain.x $filename_fg $filename_anal1 $filename_anal2 $filename_anal $filenamein $filenameout $alpha $beta $nanals"
set errorcode=0
